...
import { db } from "./db";
import {
  requireAuth, verifyPassword, signToken,
...
// ── Auth (public — must be registered BEFORE the requireAuth guard) ───────────
...
// ── Auth guard — all routes below this line require a valid session ────────────
...
export function serveUploads(app: any, authMiddleware: any) {
