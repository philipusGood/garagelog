 ...
 * Run once to import historical service records.
 * Usage: npm run seed
 */
...
const records: Parameters<typeof createRecord>[0][] = [
  {
    car_id: car.id,
    date: "2006-08-17",
    mileage: 21142,
  ...
  },
  {
    ...
    cost: 580.74,
    notes: "Invoice #11130. Battery MT91, 10L synthetic oil, oil filter, drain plug seal, rear park light bulb replaced.",
  ...
  },
  {
    ...
    cost: 789.67,
    notes: "Invoice #13519. Driver side convertible top cable broken — removed partial top, replaced cable. 2x hood shocks installed.",
  ...
  },
  {
    ...
    cost: 4430.88,
    notes: "Invoice #15134. AYR maintenance: oil & filter change, spark plugs replaced, ignition coils replaced (in bad shape), drive belts checked, undercarriage checked for leaks. Emissions test. Spare key fob programmed.",
  ...
  },
  {
    ...
    mileage: 57692,
    shop: "G-Tek Automotive Corp.",
    description: "Oil & filter, coolant expansion tank, park lights",
    cost: 1545.98,
    notes: "Invoice #17444. Oil & filter change, 9L engine oil. Coolant expansion tank and cap replaced, coolant drained and refilled. Left front park light and right front running light replaced.",
